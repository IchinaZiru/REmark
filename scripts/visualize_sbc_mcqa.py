...
# SBC結果のCSVファイル（outputs/sbc_results/L*.csv）
sbc_csv_paths = sorted(glob.glob("outputs/sbc_results/L[0-7].csv"))

# mcqa結果（統合ファイル）：outputs/merged_results/merged_scores.csv
mcqa_path = "outputs/merged_results/merged_scores.csv"

# SBCデータを読み込み、レベル情報を追加
sbc_dataframes = []
...
# 2. フィールド別の平均比較（Trigger/Action/Effect/Constraint）
